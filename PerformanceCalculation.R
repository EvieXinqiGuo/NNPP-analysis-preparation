# load the dataset(s)
getwd()
setwd("/Users/guoxinqieve/Library/CloudStorage/OneDrive-UCSanDiego/Dissertation/NNPP (NO manipulation)/NNPP_data/NNPP_survey/PrivateSpeech_PerformanceCalculation")
library(tidyverse)
library(readr)
library(stringr)
...
n_unluckyNoInfo_lucky = participant_performance$count_category[participant_performance$categorized_pair != "other"]/2
...
L = list.files("/Users/guoxinqieve/Library/CloudStorage/OneDrive-UCSanDiego/Dissertation/NNPP (NO manipulation)/NNPP_data/NNPP_survey/PrivateSpeech_PerformanceCalculation", ".csv")
